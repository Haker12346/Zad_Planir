...
namespace PlanZad
{
    public partial class FormAddO : MaterialForm
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Вы точно хотите добавить данные в таблицу Отдел?", "Предупреждение", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
...

            {
                using (var connection = new SqlConnection(get_cs()))
                {
                    ...
                    using (var cmd = new SqlCommand("Insert Into Deportament (DepartmentID,DepartmentName,NachalnikDepartment ) values (@DepartmentID,@DepartmentName,@NachalnikDepartment)", connection))
